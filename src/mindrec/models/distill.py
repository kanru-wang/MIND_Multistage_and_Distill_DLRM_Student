...
def logit_distill_kl(student_logits: torch.Tensor, teacher_logits: torch.Tensor, temperature: float) -> torch.Tensor:
    t=float(temperature)
...
def pairwise_logit_distill_bce(student_logits: torch.Tensor, teacher_logits: torch.Tensor, temperature: float) -> torch.Tensor:
...
def repr_distill_mse(student_repr: torch.Tensor, teacher_repr: torch.Tensor) -> torch.Tensor:
